...
const galleryMarkup = document.querySelector('ul.gallery');
const addgalleryItems = addMarkupItems(galleryItems);
galleryMarkup.insertAdjacentHTML('beforeend', addgalleryItems);
